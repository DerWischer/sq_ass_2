...
\centering
	...
	\end{tabular} 
\label{tbl:ranking}
\caption{This table shows the ranking of human perceived complexity. 1 is the highest and 5 the lowest complexity.}
\end{table}
